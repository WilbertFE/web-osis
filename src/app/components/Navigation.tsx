        ...
        <div className="flex gap-x-1 items-center md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
          {status === "unauthenticated" && (
            <button
              ...
              className="px-4 mx-2 cursor-pointer py-0.5 flex items-center gap-x-2 font-bold border-2 border-black dark:border-white uppercase bg-white text-black transition duration-200 text-sm shadow-[1px_1px_rgba(0,0,0),2px_2px_rgba(0,0,0),3px_3px_rgba(0,0,0),4px_4px_rgba(0,0,0),5px_5px_0px_0px_rgba(0,0,0)] dark:shadow-[1px_1px_rgba(255,255,255),2px_2px_rgba(255,255,255),3px_3px_rgba(255,255,255),4px_4px_rgba(255,255,255),5px_5px_0px_0px_rgba(255,255,255)] "
            >
              <FcGoogle size={32} />
              Login
            </button>
